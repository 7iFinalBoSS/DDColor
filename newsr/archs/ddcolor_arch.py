...
from newsr.archs.ddcolor_arch_utils.unet import Hook, CustomPixelShuffle_ICNR,  UnetBlockWide, NormType, custom_conv_layer
from newsr.archs.ddcolor_arch_utils.convnext import ConvNeXt
from newsr.archs.ddcolor_arch_utils.transformer_utils import SelfAttentionLayer, CrossAttentionLayer, FFNLayer, MLP
from newsr.archs.ddcolor_arch_utils.position_encoding import PositionEmbeddingSine
from newsr.archs.ddcolor_arch_utils.transformer import Transformer
from newsr.utils.registry import ARCH_REGISTRY
...
class Encoder(nn.Module):
    ...
    def load(self, path):
        from newsr.utils import get_root_logger
